...
export function FloatingToolbarOptions({
  ...
  return (
    <motion.div
      ...
      className="p-1 rounded-lg border shadow-lg border-border/80 bg-card pointer-events-auto origin-top text-white"
      ...
      <div className="flex items-center justify-center gap-1">
        ...
        <label htmlFor="select-block" className="h-8 items-center align-top">
          ...
          <select
            ...
            className="bg-white text-gray-700 border-0 h-8 pl-2 rounded-md transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring hover:bg-accent hover:text-accent-foreground data-[active]:bg-accent"
